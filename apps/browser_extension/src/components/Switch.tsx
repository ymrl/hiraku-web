...
export const Switch = ({
  ...
  >
    <span
      aria-hidden="true"
      className={
        "before:content-[''] before:absolute before:top-1.5 before:bottom-1.5 before:right-3 before:w-0 before:-rotate-45 " +
        "before:border-l-2 before:border-white before:opacity-80 " +
        "after:content-[''] after:absolute after:top-1.5 after:bottom-1.5 after:right-3 after:w-0 after:rotate-45 " +
        "after:border-l-2 after:border-white after:opacity-80"
      }
    />
    <span
      aria-hidden="true"
      className={
        "after:content-[''] after:absolute after:top-1.5 after:left-1.5 after:w-3 after:h-2 after:-rotate-45 " +
        "after:border-2 after:border-l-white after:border-b-white after:border-t-transparent after:border-r-transparent after:opacity-80"
      }
    />
